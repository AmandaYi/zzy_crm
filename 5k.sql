...
--
-- Host: 127.0.0.1
-- Generation Time: 2019-03-07 09:59:43
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
(1, 1, 'customer', 'add', NULL, 1, '管理员admin在2019-03-06 10:25:57添加了id为1的客户。', 1551839157),
(2, 1, 'user', 'add', NULL, 2, '管理员admin在2019-03-06 16:08:09添加了id为2的员工。', 1551859689),
(3, 1, 'customer', 'add', NULL, 2, '管理员admin在2019-03-06 16:14:50添加了id为2的客户。', 1551860090),
(4, 1, 'customer', 'edit', NULL, 2, '管理员admin在2019-03-07 17:28:37修改了id为2的客户。', 1551950917);
...
(1, 'defaultinfo', 'a:8:{s:4:"name";s:15:"商帅商学院";s:11:"description";s:33:"商帅商学院关系管理系统";s:5:"state";s:9:"北京市";s:4:"city";s:9:"市辖区";s:15:"allow_file_type";s:40:"pdf,doc,jpg,png,gif,txt,doc,xls,zip,docx";s:19:"contract_alert_time";i:30;s:10:"task_model";s:1:"2";s:4:"logo";s:37:"./Uploads/201903/06/5c7f259d40983.png";}', ''),
...
CREATE TABLE `5kcrm_customer` (
  ...
  `delete_role_id` int(10) NOT NULL COMMENT '删除人',
  `delete_time` int(10) NOT NULL COMMENT '删除时间',
  `crm_safeqc` varchar(22) NOT NULL DEFAULT ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='本表存放客户的相关信息';

--
-- 转存表中的数据 `5kcrm_customer`
--

INSERT INTO `5kcrm_customer` (`customer_id`, `owner_role_id`, `creator_role_id`, `contacts_id`, `name`, `origin`, `address`, `zip_code`, `industry`, `annual_revenue`, `ownership`, `rating`, `create_time`, `update_time`, `is_deleted`, `is_locked`, `delete_role_id`, `delete_time`, `crm_safeqc`) VALUES
(1, 1, 1, 0, '111', '', '北京市\n市辖区', '', '', '', '', '', 1551839157, 1551839157, 0, 0, 0, 0, '111111'),
(2, 1, 1, 0, '张三', '电话营销', '北京市\n市辖区\n\n', '', '', '10-20万', '国企', '二星', 1551860090, 1551950917, 0, 0, 0, 0, '411325515156656');
...
--
-- 转存表中的数据 `5kcrm_customer_data`
--

INSERT INTO `5kcrm_customer_data` (`customer_id`, `no_of_employees`, `description`) VALUES
(1, '', ''),
(2, '20-50人', '');
...
--
-- 转存表中的数据 `5kcrm_customer_record`
--

INSERT INTO `5kcrm_customer_record` (`id`, `customer_id`, `user_id`, `start_time`, `type`) VALUES
(1, 2, 1, 1551860109, 1);
...
INSERT INTO `5kcrm_event` (`event_id`, `owner_role_id`, `subject`, `start_date`, `end_date`, `venue`, `contacts_id`, `customer_id`, `creator_role_id`, `create_date`, `update_date`, `business_id`, `leads_id`, `send_email`, `recurring`, `description`, `isclose`, `is_deleted`, `delete_role_id`, `delete_time`) VALUES
(1, 1, '今天要去拜访客户哦', 1551888000, 0, '', 0, 0, 1, 1551950431, 1551950431, 0, 0, 1, 0, '', 0, 0, 0, 0);
...
(8, 'customer', 1, 'name', '客户名称', 'text', '', '5521FF', 333, 1, 1, 1, 1, 1, '必须输入客户名称', '', 0, 1),
...
(50, 'customer', 1, 'crm_safeqc', '客户身份证', 'text', '', 'E70012', 22, 1, 1, 1, 1, 1, '客户身份证必须填写', '', 0, 0);
...
(1, 1, 1551835714, '127.0.0.1', '1'),
(2, 1, 1551859338, '109.232.240.7', '1'),
(3, 1, 1551859625, '127.0.0.1', '1'),
(4, 1, 1551859713, '109.232.240.7', '1'),
(5, 1, 1551950386, '127.0.0.1', '1'),
(6, 1, 1551950631, '193.37.254.173', '1');
...
(1, '线索', '/index.php?m=leads', 'top', 0, 'Leads'),
(2, '客户', '/index.php?m=customer', 'top', 1, 'Customer'),
(3, '商机', '/index.php?m=business', 'top', 2, 'Business'),
(4, '产品', '/index.php?m=product', 'top', 3, 'Product'),
(5, '任务', '/index.php?m=task', 'top', 4, 'Task'),
(6, '日程', '/index.php?m=event', 'top', 5, 'Event'),
(7, '合同', '/index.php?m=contract', 'top', 6, 'Contract'),
(8, '财务', '/index.php?m=finance', 'top', 7, 'Finance'),
(9, '日志', '/index.php?m=log', 'more', 0, ''),
(10, '知识', '/index.php?m=knowledge', 'more', 1, 'Knowledge'),
(11, '营销', '/index.php?m=setting&a=sendsms', 'more', 2, ''),
(12, '站内信', '/index.php?m=message', 'more', 3, ''),
(13, '我的面板', '/', 'user', 0, ''),
(14, '个人资料', '/index.php?m=user&a=edit', 'user', 1, ''),
(15, '组织架构', '/index.php?m=user', 'user', 2, ''),
(16, '权限分配', '/index.php?m=user&a=role', 'user', 3, 'Role'),
(17, '公告管理', '/index.php?m=announcement', 'user', 4, 'announcement'),
(18, '操作日志', '/index.php?m=action_log', 'user', 5, ''),
(19, '系统设置', '/index.php?m=setting', 'user', 6, 'Setting');
...
(1, 1, 1, 1, 'admin', '', '7cef2bb887a2f982f06be860a95bdea1', 'd730', 0, '', '', '', 'a:3:{s:3:"top";a:9:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";i:3;s:1:"4";i:4;s:1:"5";i:5;s:1:"6";i:6;s:1:"7";i:7;s:1:"8";i:8;s:2:"15";}s:4:"user";a:6:{i:0;s:2:"13";i:1;s:2:"14";i:2;s:2:"16";i:3;s:2:"17";i:4;s:2:"18";i:5;s:2:"19";}s:4:"more";a:4:{i:0;s:1:"9";i:1;s:2:"10";i:2;s:2:"11";i:3;s:2:"12";}}', '', '', '127.0.0.1', 1551423274, 0, 0, '', '{"task":1551951668,"event":1551951667,"contract":1551950880}'),
(2, 2, 1, 1, 'admin2', '', '72a86a973ab85a7eec036b8b68041de4', 'f390', 0, '', '', '', 'a:3:{s:3:"top";a:8:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";i:3;s:1:"4";i:4;s:1:"5";i:5;s:1:"6";i:6;s:1:"7";i:7;s:1:"8";}s:4:"more";a:4:{i:0;s:1:"9";i:1;s:2:"10";i:2;s:2:"11";i:3;s:2:"12";}s:4:"user";a:7:{i:0;s:2:"13";i:1;s:2:"14";i:2;s:2:"15";i:3;s:2:"16";i:4;s:2:"17";i:5;s:2:"18";i:6;s:2:"19";}}', '', '', '127.0.0.1', 1551859689, 0, 0, '', '');
...
--
ALTER TABLE `5kcrm_customer`
  MODIFY `customer_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '客户id', AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `5kcrm_event`
  MODIFY `event_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '活动id', AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `5kcrm_fields`
--
ALTER TABLE `5kcrm_fields`
  MODIFY `field_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=51;
--
...
--
ALTER TABLE `5kcrm_leads`
  MODIFY `leads_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '线索主键';
--
...
--
ALTER TABLE `5kcrm_position`
  MODIFY `position_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '岗位id', AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `5kcrm_role`
  MODIFY `role_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '岗位id', AUTO_INCREMENT=3;
--
-- 使用表AUTO_INCREMENT `5kcrm_role_department`
--
ALTER TABLE `5kcrm_role_department`
  MODIFY `department_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '部门id', AUTO_INCREMENT=2;
--
